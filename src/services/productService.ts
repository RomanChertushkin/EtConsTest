...
export class ProductService {
  ...
  public async getProductsWithOrdersData(): Promise<Product[]> {
  ...
  public async getProductsMini(): Promise<Product[]> {
    const products = await this.getProducts()
    return Promise.resolve(products.slice(0, 5))
  }

  public async getProductsSmall(): Promise<Product[]> {
    const products = await this.getProducts()
    return Promise.resolve(products.slice(0, 10))
  }

  public async getProductsWithOrdersSmall(): Promise<Product[]> {
    const products = await this.getProductsWithOrdersData()
    return Promise.resolve(products.slice(0, 10))
  }

  public async getProductsWithOrders(): Promise<Product[]> {
